...
- Dedicated attending coverage on the Call tab for EGS, Trauma, SCC, consolidated ACS night call, day/night backup, Practice/Elective, Vascular, and Pediatrics. The three independent lines support separate day/night assignments on every date, automatic night-to-day fallback, weekend-day carryover for missing Friday-Sunday entries, and a backward-compatible Friday 5 PM–Monday 6 AM weekend shorthand. Call-day cards expand to the full team and the main calendar shows compact PR/V/PEDS coverage. A designated minimally invasive fellow may cover Practice weekend call while remaining outside the resident call pool.
